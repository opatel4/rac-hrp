...
rebalances coincide with greater hierarchical restructuring when restructuring is
measured over the interval the trigger actually spans. Its timing is not random, and
its burstiness survives two regime-free pipeline nulls.
