...
**Status:** rev.2 — FROZEN. To be hashed and committed before any implementing code is
written.
**Author:** Om Patel
...
| Base seed | 102633858 (OS entropy) |
...
rev.2 supersedes rev.1 (ba5c946), which was committed with the base seed still unfilled. rev.1 is preserved unaltered as the historical record; no Phase 2F code existed at either commit.
