...
**Status:** rev.3 — FREEZE CANDIDATE. To be hashed and committed before any Phase 2E code is
written.
**Author:** Om Patel
...
sign-off block with a self-binding freeze record; strengthened the provenance statement.
